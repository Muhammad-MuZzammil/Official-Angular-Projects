...
@Component({
  selector: 'about-saiyaara',
  templateUrl: './about-saiyaara.component.html',
  styleUrls: ['./about-saiyaara.component.css']
})
export class AboutSaiyaaraComponent implements OnInit {
  userData: any;
  generalVarArr = []
  constructor(private commonSer: CommonService, private transferDataService: TransferDataService) { }

  ngOnInit() {
    this.generalVarArr['is_login'] = this.commonSer.is_login()
    .subscribe(res => {
      this.userData = res
